...
public class calculatorGUI {
    ...
    public calculatorGUI(){
        ...
        ansLabel = new JLabel("Ansa will appear here");
        ...
        addBtton.addActionListener(handler);
        subBtton.addActionListener(handler);
        divBtton.addActionListener(handler);
        mulBtton.addActionListener(handler);
